...
class run:
	...
	def main(self):
		...
		plt.vlines(Tc_10p, fig.axes.get_ylim()[0], fig.axes.get_ylim()[1], color="tab:red", linestyle="--", linewidth=self.linewidth_fit)
		plt.vlines(Tc_90p, fig.axes.get_ylim()[0], fig.axes.get_ylim()[1], color="tab:red", linestyle="--", linewidth=self.linewidth_fit)
